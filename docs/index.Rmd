...
level of https://github.com/everhartlab/IntroR-at-OSU. As the workshop is 
designed to be interactive where the participants are given some control over what direction we should take the analyses, the scripts here are only to serve as guidelines.
...
The website located at http://everhartlab.github.io/IntroR-at-OSU can be build via 
the `make` program:
